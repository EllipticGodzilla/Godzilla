...
public class GFileChooser extends JButton {
    ...
    public GFileChooser(JTextField output, String description, String... extensions) {
        ...
        this.setIcon(new ImageIcon(GFileChooser.class.getResource("/images/files.png")));
        this.setRolloverIcon(new ImageIcon(GFileChooser.class.getResource("/images/files_sel.png")));
        this.setPressedIcon(new ImageIcon(GFileChooser.class.getResource("/images/files_pres.png")));
